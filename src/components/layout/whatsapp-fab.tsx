...
export function WhatsappFab() {
  ...
  const greeting =
    lang === "es"
      ? `Hola Nicolas, me interesa una propiedad de Hooli Real Estate.`
      : `Hi Nicolas, I am interested in a Hooli Real Estate listing.`;
  ...
  return (
    ...
    >
      <WhatsappIcon />
      <span className="pr-1 text-sm font-semibold">{copy.whatsapp}</span>
    </a>
  );
}
