import { s as copy } from "./router-DfBzAlA4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/format-D3JgkcQL.js
var listings = [
	{
		id: "casa-palmar",
	...
	},
	{
		...
		area: "playa-del-carmen",
		neighborhood: {
			es: "Centro / Quinta Avenida",
			en: "Downtown / Fifth Avenue"
		},
	...
	},
	{
		...
		area: "puerto-morelos",
		neighborhood: {
			es: "Puerto Morelos Playa",
			en: "Puerto Morelos Beach"
		},
	...
	},
	{
		...
		neighborhood: {
			es: "Puerto Aventuras Marina",
			en: "Puerto Aventuras Marina"
		},
	...
	},
	{
		...
		area: "tulum",
		neighborhood: {
			es: "Región Tulum / selva",
			en: "Tulum region / jungle"
		},
	...
	},
	{
		...
		area: "cancun",
		neighborhood: {
			es: "Punta Nizuc / sur de Cancún",
			en: "Punta Nizuc / south Cancun"
		},
...
var condoTypes = ["condo", "penthouse"];
function formatPrice(listing, lang) {
	...
	return `${listing.priceFrom ? `${copy.from[lang]} ` : ""}${formatted}`;
}
function formatM2(value, lang) {
	const locale = lang === "es" ? "es-MX" : "en-US";
	return `${new Intl.NumberFormat(locale).format(value)} ${copy.m2}`;
}
function bathTotal(listing) {
	return listing.bathrooms + (listing.halfBaths ? .5 : 0);
}
...
function mapsEmbedUrl(lat, lng, lang) {
	return `https://maps.google.com/maps?q=${lat},${lng}&z=15&hl=${lang === "es" ? "es" : "en"}&output=embed`;
}
function mapsOpenUrl(lat, lng) {
	return `https://www.google.com/maps?q=${lat},${lng}`;
}
//#endregion
export { formatM2 as a, listingBySlug as c, mapsOpenUrl as d, statusLabel as f, featuredListings as i, listings as l, condoTypes as n, formatPrice as o, typeLabel as p, developmentListings as r, houseTypes as s, bathTotal as t, mapsEmbedUrl as u };
